...
class MonodepthOptions:
    def __init__(self, withMaskRCNN=False):
        ...
        self.parser.add_argument(
            "--scales", nargs="+", type=int, help="scales used in the loss", default=[0]
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--step", type=int, help="static frames to load", default=1
        )
        ...
        self.parser.add_argument(
            "--learning_rate_maskrcnn", type=float, help="learning rate", default=2e-5
        )
        self.parser.add_argument(
            "--num_epochs", type=int, help="number of epochs", default=25
        )
        self.parser.add_argument(
            "--scheduler_step_size",
            type=int,
        ...
        self.parser.add_argument(
            "--num_workers", type=int, help="number of dataloader workers", default=4
        )
        ...
        self.parser.add_argument(
            "--maskrcnn_weights", type=str, help="name of model to load"
        )
