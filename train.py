...
from trainer_pose import Trainer
...
if __name__ == "__main__":
    ...
    print("Models loaded...")
    # print(
    #     "Number Parameters -> Encoder:",
    #     sum(p.numel() for p in trainer.models["encoder"].parameters()),
    # )
    # print("Number Parameters -> Depth:", sum(p.numel() for p in trainer.models['depth'].parameters()))
    print(
        "Number Parameters -> Pose:",
        sum(p.numel() for p in trainer.models["pose"].parameters()),
    )
